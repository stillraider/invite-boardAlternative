...
!(function (e, t) {
    ...
    function d(e) {
        ...
        function p() {
            ...
            if (
                (o < t
                    ? "hidden" === n.overflowY && (u("scroll"), a(), (o = "content-box" === n.boxSizing ? Math.round(parseFloat(window.getComputedStyle(e, null).height)) : e.offsetHeight))
                    : "hidden" !== n.overflowY && (u("hidden"), a(), (o = "content-box" === n.boxSizing ? Math.round(parseFloat(window.getComputedStyle(e, null).height)) : e.offsetHeight)),
                d !== o)
            ) {
                d = o;
